...
import com.ptapp.xmpp.jingle.stanzas.Content;
import com.ptapp.xmpp.jingle.stanzas.JinglePacket;
import com.ptapp.xmpp.jingle.stanzas.Reason;
...
public class JingleConnection implements Downloadable{
    ...
    public void init(Account account, JinglePacket packet) {
        ...
        Conversation conversation = this.mXmppConnectionService
                .findOrCreateConversation(account,
                        packet.getFrom().toBareJid(), false,null,0);
        this.message = new Message(conversation, "", Message.ENCRYPTION_NONE,null);
    ...
    private JingleSocks5Transport chooseConnection() {
        ...
        for (Map.Entry<String, JingleSocks5Transport> cursor : connections
                .entrySet()) {
