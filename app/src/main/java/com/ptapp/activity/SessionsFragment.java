...
public class SessionsFragment extends Fragment implements
    ...
    public interface Callbacks {
        public void onSessionSelected(String sessionId, String courseName,
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle data) {
        ...
        if (id == SessionsQuery.NORMAL_TOKEN) {
            ...
            loader = new CursorLoader(getActivity(), sessionsUri, SessionsQuery.NORMAL_PROJECTION,
                    selectionWhere, selectionArgs, null);
            /*loader = new CursorLoader(getActivity(), sessionsUri, SessionsQuery.NORMAL_PROJECTION,
    ...
    @Override
    public void bindCollectionItemView(Context context, View view, final int groupId, int indexInGroup, int dataIndex, Object tag) {
        ...
        Log.v(TAG, "test collection view cursor data: " +
                mCursor.getString(0) + ", " +
                mCursor.getString(1) + ", " +
                mCursor.getString(2) + ", " +
                mCursor.getString(3) + ", ");
        ...
        sessionTargetView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mCallbacks.onSessionSelected(classSubjectId, courseTitle,
                        groupJid, studentGroupId, finalPhotoView);
            }
        });
