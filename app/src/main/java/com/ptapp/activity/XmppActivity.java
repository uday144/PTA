...
public abstract class XmppActivity extends BaseActivity {
    ...
    protected ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            //SCH: setting value so other activity classes can use it.
            XmppConnectionService.setXmppConnectionService(xmppConnectionService);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                ...
                break;
            //SCH: commented as we don't need it
/*            case R.id.action_accounts:
    ...
    public void highlightInMuc(Conversation conversation, String nick) {
        CommonMethods.switchToConversation(this, conversation, null, nick, false);
    }

    //SCH: moved to CommonMethods class
...
//    }
        ...
        xmppConnectionService.getPgpEngine().generateSignature(account,
                "online", new UiCallback<Account>() {
                    ...
                    public void success(Account account) {
                        ...
                        xmppConnectionService.takeDbBackup(getApplicationContext());
                    }
    ...
    protected int findTheme() {
        if (getPreferences().getBoolean("use_larger_font", false)) {
            ...
            return R.style.Theme_Schoolo_Conversation_LargerText;
        } else {
            /*return R.style.ConversationsTheme;*/
            return R.style.Theme_Schoolo_Conversation;
        }
    }
    ...
    public void switchToConversation(Conversation conversation, String text,
                                     boolean newTask) {
        CommonMethods.switchToConversation(this, conversation,text,null,newTask);
    }
...
//    }
    ...
    //NOTE: Please use "SCH" for any customizations done in open source libraries/code
    //SCH: commenting as we don't need it for now
