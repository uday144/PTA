...
public class SearchActivity extends BaseActivity implements SessionsFragment.Callbacks {
    ...
    @Override
    public void onSessionSelected(String sessionId, String courseName, String groupJid, int groupId, View clickedView) {

    }
    /*
    @Override
    public void onSessionSelected(String sessionId, String className, String courseName, String groupJid, View clickedView) {
        *//* [ANALYTICS:EVENT]
